...
export function Navbar() {
  ...
  const logoClass    = kh ? "font-header-kh text-base lg:text-lg font-bold tracking-wide" : "font-header-en text-sm lg:text-base font-bold tracking-[0.08em] uppercase";
  const navLinkClass = kh ? "font-header-kh text-[13px] lg:text-[14px] font-bold" : "font-header-en text-[11px] lg:text-[13px] font-bold tracking-[0.1em] uppercase";
  const searchClass  = kh ? "font-body-kh text-sm" : "font-body-en text-[13px] tracking-[0.02em]";
      ...
      {mobileOpen && (
        <div className="lg:hidden bg-white border-t border-black/10 px-4 py-4 space-y-1 max-h-[80vh] overflow-y-auto">
          ...
          <div className="flex items-center gap-2 border border-black/10 rounded-lg px-3 py-2 mb-4">
            <button onClick={handleMobileSearch} aria-label="Search">
