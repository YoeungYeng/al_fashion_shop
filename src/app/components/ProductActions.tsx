...
`.trim();
  ...
  const buttonClass =
    "w-full h-10 text-xs sm:text-sm md:text-base flex items-center hover:cursor-pointer justify-center gap-2 text-sm font-semibold text-white transition-all duration-200 active:scale-95";
