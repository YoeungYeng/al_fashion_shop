...
export const products: Product[] = [
  {
    ...
    price: 180, discount: 10, category: "classic-boots",
    images: [
    ...
    inStock: true, isNew: false, isPopular: true, createdAt: "2025-01-10",
    telegramLink: `${TELEGRAM_BASE}?start=shoe_1`, brand: "Timberland",
    sizes: ["39","40","41","42","43","44"], color: "Wheat",
  },
  {
    id: 2,
    ...
    price: 120, discount: 5, category: "chelsea-boots",
    images: [
    ...
    inStock: true, isNew: true, isPopular: true, createdAt: "2025-01-12",
    telegramLink: `${TELEGRAM_BASE}?start=shoe_2`, brand: "Classic",
  ...
  },
  {
    ...
    price: 140, discount: 0, category: "work-boots",
    images: [
    ...
    inStock: true, isNew: true, isPopular: false, createdAt: "2025-01-15",
    telegramLink: `${TELEGRAM_BASE}?start=shoe_3`, brand: "Worker Pro",
    sizes: ["40","41","42","43","44"], color: "Brown",
  },
  {
    id: 4,
    slug: "oxford-brown",
    ...
    price: 95, discount: 0, category: "oxford",
    images: [
    ...
    inStock: true, isNew: false, isPopular: true, createdAt: "2025-01-18",
    telegramLink: `${TELEGRAM_BASE}?start=shoe_4`, brand: "Oxford Classic",
    sizes: ["39","40","41","42","43"], color: "Brown",
  },
  {
    id: 5,
    slug: "oxford-black",
    ...
    price: 100, discount: 5, category: "oxford",
    images: [
    ...
    inStock: true, isNew: false, isPopular: true, createdAt: "2025-01-20",
    telegramLink: `${TELEGRAM_BASE}?start=shoe_5`, brand: "Oxford",
    sizes: ["39","40","41","42","43","44"], color: "Black",
  },
  {
    id: 6,
    ...
    price: 85, discount: 0, category: "loafers",
    images: [
    ...
    inStock: true, isNew: true, isPopular: true, createdAt: "2025-01-22",
    telegramLink: `${TELEGRAM_BASE}?start=shoe_6`, brand: "Loafer Co",
    sizes: ["39","40","41","42"], color: "Brown",
  },
  {
    id: 7,
    ...
    price: 110, discount: 10, category: "sandals",
    images: [
    ...
    inStock: true, isNew: false, isPopular: true, createdAt: "2025-01-25",
    telegramLink: `${TELEGRAM_BASE}?start=shoe_7`, brand: "Luxury Step",
    sizes: ["39","40","41","42","43"], color: "Black",
  },
  {
    id: 8,
    ...
    price: 90, discount: 0, category: "loafers",
    images: [
    ...
    inStock: true, isNew: false, isPopular: false, createdAt: "2025-02-01",
    telegramLink: `${TELEGRAM_BASE}?start=shoe_8`, brand: "Derby Style",
    sizes: ["39","40","41","42","43"], color: "Brown",
  },
  {
    id: 9,
    ...
    price: 92, discount: 5, category: "loafers",
    images: [
    ...
    inStock: true, isNew: false, isPopular: true, createdAt: "2025-02-05",
    telegramLink: `${TELEGRAM_BASE}?start=shoe_9`, brand: "Derby Pro",
    sizes: ["39","40","41","42","43","44"], color: "Black",
  },
  {
    id: 10,
    ...
    price: 165, discount: 12, category: "classic-boots",
    images: [
    ...
    inStock: true, isNew: true, isPopular: true, createdAt: "2025-06-01",
    telegramLink: `${TELEGRAM_BASE}?start=shoe_10`, brand: "Geto",
    sizes: ["39","40","41","42","43","44"], color: "Tan",
  },
  {
    id: 11,
    ...
    price: 135, discount: 8, category: "classic-boots",
    images: [
      "https://images.unsplash.com/photo-1600185365483-26d7a4cc7519?w=800",
      "https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=800",
      "https://images.unsplash.com/photo-1560769629-975ec94e6a86?w=800",
    ...
    inStock: true, isNew: false, isPopular: true, createdAt: "2025-06-03",
    telegramLink: `${TELEGRAM_BASE}?start=shoe_11`, brand: "Geto",
    sizes: ["40","41","42","43"], color: "Brown Suede",
  },
  {
    id: 12,
    ...
    price: 125, discount: 5, category: "classic-boots",
    images: [
      "https://images.unsplash.com/photo-1560769629-975ec94e6a86?w=800",
      "https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=800",
      "https://images.unsplash.com/photo-1600185365483-26d7a4cc7519?w=800",
    ...
    inStock: true, isNew: true, isPopular: false, createdAt: "2025-06-05",
    telegramLink: `${TELEGRAM_BASE}?start=shoe_12`, brand: "Geto",
    sizes: ["39","40","41","42","43"], color: "Beige",
  },
  {
    id: 13,
    ...
    price: 115, discount: 0, category: "brogue",
    images: [
    ...
    inStock: true, isNew: false, isPopular: true, createdAt: "2025-06-07",
    telegramLink: `${TELEGRAM_BASE}?start=shoe_13`, brand: "Heritage",
    sizes: ["39","40","41","42","43","44"], color: "Brown",
  },
  {
    id: 14,
    ...
    price: 130, discount: 10, category: "monk-strap",
    images: [
    ...
    inStock: true, isNew: true, isPopular: true, createdAt: "2025-06-08",
    telegramLink: `${TELEGRAM_BASE}?start=shoe_14`, brand: "Geto",
    sizes: ["39","40","41","42","43"], color: "Black",
  },
  {
    id: 15,
    ...
    price: 155, discount: 15, category: "classic-boots",
    images: [
    ...
    inStock: true, isNew: false, isPopular: true, createdAt: "2025-06-09",
    telegramLink: `${TELEGRAM_BASE}?start=shoe_15`, brand: "Geto",
    sizes: ["40","41","42","43","44"], color: "Chestnut",
  },
  {
    id: 16,
    ...
    price: 98, discount: 0, category: "loafers",
    images: [
    ...
    inStock: true, isNew: false, isPopular: false, createdAt: "2025-06-10",
    telegramLink: `${TELEGRAM_BASE}?start=shoe_16`, brand: "Geto",
    sizes: ["39","40","41","42"], color: "Navy Suede",
  },
  {
    id: 17,
    ...
    price: 145, discount: 7, category: "classic-boots",
    images: [
      "https://images.unsplash.com/photo-1549298916-b41d501d3772?w=800",
      "https://images.unsplash.com/photo-1608256246200-53e635b5b65f?w=800",
      "https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=800",
    ...
    inStock: true, isNew: true, isPopular: true, createdAt: "2025-06-11",
    telegramLink: `${TELEGRAM_BASE}?start=shoe_17`, brand: "Geto",
    sizes: ["39","40","41","42","43","44"], color: "Dark Brown",
  },
  {
    id: 18,
    ...
    price: 160, discount: 20, category: "sneakers",
    images: [
    ...
    inStock: true, isNew: false, isPopular: true, createdAt: "2025-06-12",
    telegramLink: `${TELEGRAM_BASE}?start=shoe_18`, brand: "Geto",
    sizes: ["39","40","41","42","43"], color: "Black",
  },
  {
    id: 19,
    ...
    price: 138, discount: 0, category: "sneakers",
    images: [
    ...
    inStock: true, isNew: false, isPopular: false, createdAt: "2025-06-13",
    telegramLink: `${TELEGRAM_BASE}?start=shoe_19`, brand: "Sneakers",
    sizes: ["40","41","42","43","44"], color: "Olive",
  },
  {
    id: 20,
    ...
    price: 108, discount: 8, category: "sneakers",
    images: [
    ...
    inStock: true, isNew: true, isPopular: true, createdAt: "2025-06-14",
    telegramLink: `${TELEGRAM_BASE}?start=shoe_20`, brand: "Geto",
    sizes: ["39","40","41","42","43"], color: "Burgundy",
  },
];
